...
async function starts() {
  ...
  const ownerNumber = ["62895331406727@s.whatsapp.net"]
...
const inii = ttno.data.data.download.download_server_2
sendFileFromUrl(ini, video, {mimetype: 'video/mp4', quoted: msg, filename: `tiktok.mp4`})
await sendFileFromUrl(inii, video, {mimetype: 'video/mp4', quoted: msg, filename: `tiktok.mp4`})
break
case 'ytmp3':
if (!isGroup) return reply('bot tidak bisa melayani privat chat!')
if (args.length < 1) return reply('Link Nya Mana?')
